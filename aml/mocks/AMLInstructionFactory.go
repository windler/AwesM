...
// AMLInstructionFactory is an autogenerated mock type for the AMLInstructionFactory type
type AMLInstructionFactory struct {
	mock.Mock
}

// GetPattern provides a mock function with given fields:
func (_m *AMLInstructionFactory) GetPattern() string {
	ret := _m.Called()
...
func (_m *AMLInstructionFactory) New(name string) *instructions.AMLInstruction {
	ret := _m.Called(name)
...
func (_m *AMLInstructionFactory) NewForkNode(name string) *instructions.AMLInstruction {
	ret := _m.Called(name)
...
func (_m *AMLInstructionFactory) NewJoinNode(name string, forkNode *instructions.AMLInstruction) *instructions.AMLInstruction {
